...
/*!
    ...
    \brief This property contains flags to guide rendering of the scene node, including culling and debug rendering modes.

    The default value is QGLSceneNode::NoOptions, indicating no special treatment of the node.
    see \l Option for details on the individual flags.
    \sa Option
*/
