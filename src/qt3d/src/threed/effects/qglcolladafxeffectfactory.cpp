...
/*!
    ...
    The QGLColladaFxFactory class creates
    a list of QGLColladaFx objects from COLLADA FX
    information according to the 1.4.1 March 2008
    Release from http://www.khronos.org/collada/
...
/*!
    \internal
    \fn QStringList QGLColladaFxEffectFactory::generateBindUniformElement( QGLColladaFxEffect* effect )
*/
